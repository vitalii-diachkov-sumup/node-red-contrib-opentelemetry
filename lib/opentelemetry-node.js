...
module.exports = function (RED) {
  ...
  function OpenTelemetryNode (config) {
    ...
    /**
      ...
      */
    function isIgnored (nodeDefinition) {
      return ignoredTypesList.includes(nodeDefinition.type) || ignoredFlowsList.includes(nodeDefinition.z)
    }
    ...
    RED.hooks.add('onSend.otel', (events) => {
      ...
      createSpan(tracer, events[0].msg, nodeDefinition, node, isIgnored(nodeDefinition))
    })
    ...
    RED.hooks.add('postDeliver.otel', (sendEvent) => {
      ...
      const span = createSpan(tracer, sendEvent.msg, nodeDefinition, node, isIgnored(nodeDefinition))
